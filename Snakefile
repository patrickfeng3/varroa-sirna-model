...
rule all:
    input:
        ...
        "results/07_empirical_sequence/feature_synthesis/wang_bartel_grouped_by_sample.tsv",
        "results/07_empirical_sequence/feature_synthesis/wang_bartel_grouped_summary.tsv",
        "results/07_empirical_sequence/feature_synthesis/cross_length_same_3p.tsv",
        "results/07_empirical_sequence/feature_synthesis/cross_length_same_5p.tsv",
